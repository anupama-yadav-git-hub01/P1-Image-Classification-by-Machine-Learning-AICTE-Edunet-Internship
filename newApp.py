...
def cifar10_classification():
    ...
    if uploaded_file is not None:
        ...
        class_names = ['airplane', 'automobile', 'bird', 'cat', 'deer', 'dog', 'frog', 'horse', 'ship', 'truck', 'apple', 'banana', 'grapesh', 'papaya', 'mango', 'parrot', 'peacock', 'rabbit', 'tiger', 'lion', 'ziraf', 'chair']
        # Preprocess the image
